      ...
      >
        ...
        >
          ...
          <svg
            ...
            class="icon icon-tabler icons-tabler-outline icon-tabler-brand-github opacity-80"
          >
        ...
        >
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-brand-linkedin opacity-80"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path d="M8 11v5" />
            <path d="M8 8v.01" />
